...
curl -s -X POST "$API" -H "$AUTH" -H "$CT" -d '{
  ...
  "metaTitle": "AppAI — Free Hosting for AI-Built Apps | Landing Page Demo",
  "metaDescription": "Create beautiful landing pages for your AI-built apps in 30 seconds. Free hosting, privacy policy, and terms of service included. No domain needed.",
  "themeColor": "#2563EB",
  "isPublished": true,
...
curl -s -X POST "$API" -H "$AUTH" -H "$CT" -d '{
  ...
  "metaTitle": "CodePilot AI — AI-Powered Code Review for Teams | SaaS Demo",
  "metaDescription": "Ship better code faster with AI-powered pull request reviews. Catches bugs, enforces style, supports 20+ languages. Free tier available.",
  "themeColor": "#7C3AED",
  "isPublished": true,
  "category": "CODING",
  "content": {
...
curl -s -X POST "$API" -H "$AUTH" -H "$CT" -d '{
  ...
  "metaTitle": "Grayson K. — Developer & Creator of AppAI | Profile Demo",
  "metaDescription": "Full-stack developer and AI enthusiast. Building tools that let AI agents create things for humans. Creator of AppAI.",
  "themeColor": "#0EA5E9",
  "isPublished": true,
  "category": "OTHER",
  "content": {
...
curl -s -X POST "$API" -H "$AUTH" -H "$CT" -d '{
  ...
  "metaTitle": "AppAI Links — All Our Links in One Place | Link-in-Bio Demo",
  "metaDescription": "Find all AppAI links in one place. Website, GitHub, agent spec, app directory, and more. Free link-in-bio page template.",
  "themeColor": "#F59E0B",
  "isPublished": true,
  "category": "OTHER",
  "content": {
...
curl -s -X POST "$API" -H "$AUTH" -H "$CT" -d '{
  ...
  "metaTitle": "Pixel Studio — Design & Development Studio | Portfolio Demo",
  "metaDescription": "Award-winning design and development studio. 50+ projects delivered across 12 countries. Specializing in AI-powered products and brand identity.",
  "themeColor": "#EC4899",
  "isPublished": true,
  "category": "DESIGN",
  "content": {
...
curl -s -X POST "$API" -H "$AUTH" -H "$CT" -d '{
  ...
  "metaTitle": "AI Builder Summit 2026 — Developer Conference | Event Page Demo",
  "metaDescription": "June 15-16, San Francisco. Two days of talks, workshops, and networking for 500+ developers building the AI-powered future. Tickets from $199.",
  "themeColor": "#DC2626",
  "isPublished": true,
  "category": "EDUCATION",
  "content": {
